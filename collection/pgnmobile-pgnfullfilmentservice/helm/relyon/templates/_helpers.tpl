...
*/}}
{{- define "pgnmobile-pgnfullfilmentservice.name" -}}
...
*/}}
{{- define "pgnmobile-pgnfullfilmentservice.fullname" -}}
...
*/}}
{{- define "pgnmobile-pgnfullfilmentservice.chart" -}}
...
Common labels
*/}}
{{- define "pgnmobile-pgnfullfilmentservice.labels" -}}
helm.sh/chart: {{ include "pgnmobile-pgnfullfilmentservice.chart" . }}
{{ include "pgnmobile-pgnfullfilmentservice.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "pgnmobile-pgnfullfilmentservice.selectorLabels" -}}
app.kubernetes.io/name: {{ include "pgnmobile-pgnfullfilmentservice.name" . }}
...
*/}}
{{- define "pgnmobile-pgnfullfilmentservice.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "pgnmobile-pgnfullfilmentservice.fullname" .) .Values.serviceAccount.name }}
{{- else }}
